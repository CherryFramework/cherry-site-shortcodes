 ...
 * @since 1.0.0
 */
class Cherry_3rd_Section_Shortcode extends Cherry_Section_Shortcode {
	...
	public function shortcode_registration() {
		cherry_shortcodes_admin()->base_shortcodes_settings[] = array(
			'title'       => esc_html__( '3rd Section', 'cherry-site-shortcodes' ),
...
Cherry_3rd_Section_Shortcode::get_instance();
